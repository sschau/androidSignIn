...
public class AzureInMemoryCacheStore  implements ITokenCacheStore, ITokenStoreQuery {

    private static final long serialVersionUID = 1L;
    private static final String TAG = "AzureInMemoryCacheStore";
    private static Object sLock = new Object();
    HashMap<String, TokenCacheItem> cache = new HashMap<>();

    private static final AzureInMemoryCacheStore INSTANCE = new AzureInMemoryCacheStore();

    private AzureInMemoryCacheStore() {}

    public static AzureInMemoryCacheStore getInstance() {
        return INSTANCE;
    }
